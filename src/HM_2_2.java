...
public class HM_2_2 {
    public static void main(String[] args) {
        ...
        // Так как я свою первую попытку глупо потратил, решил добавить небольшую отсебятину
        System.out.println(permission(randomAge, randomTemperature));
    }
    ...
    public static String permission(int humanAge, int outsideTemperature) {
        {
            if ((humanAge >= 20 && humanAge <= 45 && outsideTemperature >= -20 && outsideTemperature <= 30)
                    ...
                    || (humanAge > 45 && outsideTemperature >= -10 && outsideTemperature <= 25)) {
